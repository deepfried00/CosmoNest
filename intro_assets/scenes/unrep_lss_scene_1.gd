...
@onready var unrepaired_lss = $UnrepairedLss  # Adjust this path to match the actual scene tree
...
func _ready():
	dialogue_data = load("res://intro_assets/scenes/lss_dialogue.gd").new().get_dialogue()
	robodim.play()
	show_next_line()
