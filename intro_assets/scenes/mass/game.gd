...
@onready var color_picker = $gamee/CanvasLayer2/Control/ColorPicker # ColorPicker node in the UI
@onready var sprite_to_color = $gamee # The sprite node you want to change color
@onready var reset_button = $gamee/CanvasLayer2/Control/reset # Reset button to reset color
